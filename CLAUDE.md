...
- **Most-referenced symbols:** `makeIssue` (39 usages), `reject` (12 usages), `asRecord` (12 usages), `key` (10 usages), `key` (10 usages), `rejected` (9 usages), `request` (9 usages), `requireSymbol` (8 usages), `at` (7 usages), `fillPrice` (7 usages)
- **Graph size:** 4072 nodes, 8984 edges
- **Breakdown:** 33 columns, 28 contracts, 115 docs, 211 files, 453 functions, 4 generic_params, 485 imports, 262 interfaces, 957 locals, 143 methods, 1 migrations, 5 modules, 1 packages, 672 params, 2 resources, 2 strings, 2 tables, 107 types, 589 variables

...
| File | Symbols |
|------|---------|
| `apps/backtester/src/artifacts/overlay-store.ts` | descriptors, artifactRefs, persistOverlayArtifacts, outcome, specs, ... |
| `apps/backtester/src/artifacts/store.ts` | ref, write, read, has, raw, ... |
